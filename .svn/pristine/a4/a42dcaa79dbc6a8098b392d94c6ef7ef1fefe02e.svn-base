...
public class Contact {
	...
	public Contact(String myName, String myNumber, String myMemLoc,
			int myMemIndex) {
		this.name = myName;
	...
	public String toString() {
		return String.format("Name: %s, Phone: %s, Loc: %s [%s:%d]", getName(),
				getNumber(), getLocation(), getMemLoc(), getMemIndex());
	}
	...
	public static ContactLocation convertLocationToType(String loc) {
		...
		else if (loc.equalsIgnoreCase("ME"))
