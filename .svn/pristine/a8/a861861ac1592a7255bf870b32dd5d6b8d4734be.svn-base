...
public class SendEzTextingMessage {
	...
	public void doIt() throws Exception {
		try {
			...
			System.out
					.println("Example: Send message from ExTexting HTTP Interface.");
			System.out.println(Library.getLibraryDescription());
			System.out.println("Version: " + Library.getLibraryVersion());
			EzTextingHTTPGateway gateway = new EzTextingHTTPGateway(
					"eztexting.http.1", "username", "password");
			...
			msg = new EzTextingOutboundMessage("3616885766",
					"Hello from SMSLib (EzTexting handler)", "subject", true);
