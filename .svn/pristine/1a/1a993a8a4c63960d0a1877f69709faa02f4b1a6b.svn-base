...
public enum USSDDcs {
	 ...
	 * the language
	 */
	GERMAN_7BIT(0x00), ENGLISH_7BIT(0x01), ITALIAN_7BIT(0x02), FRENCH_7BIT(0x03), SPANISH_7BIT(
			0x04), DUTCH_7BIT(0x05), SWEDISH_7BIT(0x06), DANISH_7BIT(0x07), PORTUGUESE_7BIT(
			0x08), FINNISH_7BIT(0x09), NORWEGIAN_7BIT(0x0a), GREEK_7BIT(0x0b), TURKISH_7BIT(
			0x0c), HUNGARIAN_7BIT(0x0d), POLISH_7BIT(0x0e), UNSPECIFIED_7BIT(
			0x0f),
	/**
	 * Bits 7..4 = 0001 --
	 */
