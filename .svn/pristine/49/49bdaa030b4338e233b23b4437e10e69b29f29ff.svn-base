...
public class StatusReportMessage extends InboundMessage {
	...
	public StatusReportMessage(SmsStatusReportPdu pdu, int memIndex,
			String memLocation) {
	...
	public StatusReportMessage(String myRefNo, int memIndex,
			String memLocation, Date dateOriginal, Date dateReceived) {
		super(MessageTypes.STATUSREPORT, memIndex, memLocation);
		this.refNo = myRefNo;
	...
	public StatusReportMessage(String myRefNo, String srcAddress,
			String destAddress, String text, Date dateOriginal,
			Date dateReceived) {
