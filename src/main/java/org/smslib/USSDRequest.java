...
public class USSDRequest extends USSDDatagram {
	 ...
	 * Full constructor
	 */
	public USSDRequest(USSDResultPresentation aPresentation, String aContent,
			USSDDcs aDcs, String aGatewayId) throws IllegalArgumentException {
		super();
	...
	public void setUSSDResultPresentation(
			USSDResultPresentation aResultPresentation) {
