...
public class Interface<T> {
	...
	public Interface(String myInfId, Properties myProps, SMSServer myServer,
	...
	public final String getProperty(String key, String defaultValue) {
		String value = this.props.getProperty(this.infId + "." + key,
				defaultValue);
	...
	public final boolean isInbound() {
		if (InterfaceTypes.INBOUND == this.type
				|| InterfaceTypes.INOUTBOUND == this.type)
			return true;
		return false;
	}
	...
	public final boolean isOutbound() {
		if (InterfaceTypes.OUTBOUND == this.type
				|| InterfaceTypes.INOUTBOUND == this.type)
			return true;
		return false;
	}
	...
	public void markMessages(Collection<OutboundMessage> msgList)
			throws Exception {
	...
	public void start() throws Exception {
		Logger.getInstance().logInfo(
				"SMSServer: interface: " + this.getClass().getName()
						+ " started.", null, null);
	}
