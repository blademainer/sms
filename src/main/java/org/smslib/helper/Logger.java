...
public class Logger {
	...
	protected Logger() {
		if (System.getProperties().getProperty("java.vm.name")
				.equalsIgnoreCase("ikvm.net")) {
	...
	public void logDebug(String message, Exception e, String gatewayId) {
		if (log4jLogger == null)
			return;
		log4jLogger
				.log(FQCN, Level.DEBUG, formatMessage(message, gatewayId), e);
	}
	...
	public void logError(String message, Exception e, String gatewayId) {
		if (log4jLogger == null)
			return;
		log4jLogger
				.log(FQCN, Level.ERROR, formatMessage(message, gatewayId), e);
	}

	private String formatMessage(String message, String gatewayId) {
		return ((gatewayId == null) ? message : "GTW: " + gatewayId + ": "
				+ message);
	}
}
