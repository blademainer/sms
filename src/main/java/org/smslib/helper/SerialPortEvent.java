...
public class SerialPortEvent {
	...
	public SerialPortEvent(SerialPort srcport, int eventtype, boolean oldvalue,
		...
		try {
			Constructor<?> constr = classSerialPortEvent.getConstructor(
					SerialPort.class, int.class, boolean.class, boolean.class);
			this.realObject = constr.newInstance(srcport, eventtype, oldvalue,
					newvalue);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	public int getEventType() {
		int eventType;
		try {
			Method method = classSerialPortEvent.getMethod("getEventType",
	...
	public boolean getNewValue() {
		boolean newValue;
		try {
			Method method = classSerialPortEvent.getMethod("getNewValue",
					(java.lang.Class[]) null);
	...
	public boolean getOldValue() {
		boolean oldValue;
		try {
			Method method = classSerialPortEvent.getMethod("getOldValue",
					(java.lang.Class[]) null);
