...
public abstract class AATHandler {
	...
	public abstract void reset() throws TimeoutException, GatewayException,
			IOException, InterruptedException;

	public abstract void echoOff() throws IOException, InterruptedException;

	public abstract void init() throws TimeoutException, GatewayException,
			IOException, InterruptedException;

	public abstract void done() throws TimeoutException, GatewayException,
			IOException, InterruptedException;

	public abstract boolean isAlive() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract String getSimStatus() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract boolean enterPin(String pin) throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract boolean setVerboseErrors() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract boolean setPduProtocol() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract boolean setTextProtocol() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract boolean setIndications() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract CNMIDetector getIndications();

	public abstract String getManufacturer() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract String getModel() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract String getSerialNo() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract String getImsi() throws TimeoutException, GatewayException,
			IOException, InterruptedException;

	public abstract String getSwVersion() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract String getBatteryLevel() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract String getSignalLevel() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract String getNetworkOperator() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract boolean switchStorageLocation(String mem)
			throws TimeoutException, GatewayException, IOException,
			InterruptedException;

	public abstract void switchToCmdMode() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract void keepLinkOpen() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract int sendMessage(int size, String pdu, String phone,
			String text) throws TimeoutException, GatewayException,
			IOException, InterruptedException;

	public abstract String listMessages(MessageClasses messageClass)
			throws TimeoutException, GatewayException, IOException,
			InterruptedException;

	public abstract String getMessageByIndex(int msgIndex)
			throws TimeoutException, GatewayException, IOException,
			InterruptedException;

	public abstract boolean deleteMessage(int memIndex, String memLocation)
			throws TimeoutException, GatewayException, IOException,
			InterruptedException;

	public abstract String getGprsStatus() throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract String send(String s) throws TimeoutException,
			GatewayException, IOException, InterruptedException;

	public abstract String getNetworkRegistration() throws GatewayException,
			TimeoutException, IOException, InterruptedException;

	public abstract void readStorageLocations() throws Exception;

	public abstract String sendCustomATCommand(String atCommand)
			throws GatewayException, TimeoutException, IOException,
			InterruptedException;

	public abstract String sendUSSDCommand(String ussdCommand)
			throws GatewayException, TimeoutException, IOException,
			InterruptedException;

	public abstract String sendUSSDCommand(String ussdCommand,
			boolean interactive) throws GatewayException, TimeoutException,
			IOException, InterruptedException;

	public abstract boolean sendUSSDRequest(String presentation,
			String content, String dcs) throws GatewayException,
			TimeoutException, IOException, InterruptedException;

	public abstract String formatUSSDResponse(String ussdResponse);

	public abstract String readPhonebookLocations() throws GatewayException,
			TimeoutException, IOException, InterruptedException;

	public abstract String readPhonebook(String location)
			throws GatewayException, TimeoutException, IOException;

	public abstract AsyncEvents processUnsolicitedEvents(String response)
			throws IOException;

	public static AATHandler load(ModemGateway gateway, String gsmManuf,
			String gsmModel) throws RuntimeException {
		...
		for (int i = 0; i < 3; ++i) {
			try {
				if (handlerClassNames[i] != null) {
					...
					Constructor<?> handlerConstructor = handlerClass
							.getConstructor(new Class[] { ModemGateway.class });
					atHandler = (AATHandler) handlerConstructor
							.newInstance(new Object[] { gateway });
				...
				if (i == 2) {
					...
					throw new RuntimeException(
							"Class AATHandler: Cannot initialize handler!");
				}
			}
		}
		return atHandler;
