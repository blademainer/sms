...
public class MultipartGeneratorTester {
	public static void main(String[] args) {
		...
		// pdu.setSmscAddressType(PduUtils.ADDRESS_TYPE_INTERNATIONAL |
		// PduUtils.ADDRESS_NUMBER_PLAN_ID_TELEPHONE);
		...
		// 3 8 Thank you for using this service. Your transaction has been
		// logged as TXN 7 abcdef 7 Thank you for using this service. Your
		// transaction has been logged as TXN 7 abcdefz
		// 7bit
		// PDU1:
		...
		// PDU2:
		// 0065000C9136093631073200002A0B0003040202050415B3FDE888CB653788FD3E9FCB6450780EA2629DA01B282C1E93CB663D
		// ucs2
		// PDU1:
		...
		// PDU2:
		// 
		// PDU3:
		// 0051000B819060137320F300085F6D0C050415B300000804ED090303006F007500720020007400720061006E00730061006300740069006F006E00200068006100730020006200650065006E0020006C006F0067006700650064002000610073002000540058004E002000370020006100620063006400650066007A
		pdu.addInformationElement(InformationElementFactory.generatePortInfo(
				5555, 0));
		PduGenerator generator = new PduGenerator();
		// pdu.getMpMaxNo() initially will be 1 but will be changed to the real
		// max value if concat is needed
		// upon initial generation, so this needs to get read dynamically not
