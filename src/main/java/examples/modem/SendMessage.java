...
public class SendMessage {
	public void doIt() throws Exception {
		...
		SerialModemGateway gateway = new SerialModemGateway("kingray", "COM9",
				9600, "SIEMENS", "MC39i");
		SerialModemGateway gateway2 = new SerialModemGateway("kingray2",
				"COM7", 9600, "SIEMENS", "MC39i");
		...
		// gateway.setSmscNumber("15084818017");
		...
		OutboundMessage msg = new OutboundMessage("18620300881",
				"Hello from SMSLib!");
